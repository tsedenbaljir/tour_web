...
Route::group(['middleware'=>'auth'], function(){
    ...
    Route::post('/admin/book/importData', 'adminBook@importData');
...
Route::get('/admin/note',[
    'uses' => 'adminNote@index',
    'middleware' => 'roles',
    'roles' => ['service', 'admin']
]);
// GET ALL DATA
Route::get('/admin/note/english/get','adminNote@getEnglish');
// SAVE
Route::post('/admin/note/english','adminNote@saveEnglish');
// DELETE BY ID
