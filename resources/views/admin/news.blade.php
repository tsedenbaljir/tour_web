            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Мэдээ мэдээлэл оруулах</h4>
                </div>
                      ...
                      {{-- <div class="nav-tabs-navigation">
                        ...
                        <div id="my-tab-content" class="tab-content">
                            <div class="tab-pane active" id="english">
                                <form action="/admin/news/english" method="POST" enctype="multipart/form-data">
                                  <div class="form-group">
                                    <label for="title">Гарчиг</label>
                                    <input type="text" class="form-control" id="title" placeholder="Гарчиг" name="title" required>
                                  </div>
                                  <div class="form-group" >
                                    <label for="image_description">Тайлбар</label>
                                    <textarea class="form-control" id="image_description" rows="3" placeholder="Тайлбар" required name="service_desc"></textarea>
                                  </div>
                                  <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="service-file" name="file" accept="image/jpeg, image/png">
                                    <label class="custom-file-label" for="service-file" style="font-size:14px">Зураг сонгоно уу</label>
                                  </div>
                                      @csrf
                                  ...
                                  <button type="submit" class="btn btn-primary" disabled="" id="service-submit">Хадгалах</button>
                                  <button type="reset" class="btn btn-danger" id="service-reset">Болих</button>
                            </form>
                            <div class="mt-5">
                              <div class="english-table-loading text-center">Түр хүлээнэ үү....</div>
