...
class blank extends Controller
{
    public function index(){
       ...
       return view ('client/english/blank',['service'=>$service]);
    }
    public function find($id){
        $service = ServiceEnglish::findOrFail($id);
        return view('client/english/blank_temp',['service'=>$service]);
    }
    public function mongolia(){
        $service = ServiceMongolia::all();
        return view ('client/mongolia/blank',['service'=>$service]);
    }
    public function findMongolia($id){
        $service = ServiceMongolia::findOrFail($id);
        return view('client/mongolia/blank_temp',['service'=>$service]);
    }
}
